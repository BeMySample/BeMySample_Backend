...
Route::put('jawaban-soal/edit/{id}', [JawabanSoalController::class, 'update']); 
...
Route::put('kontribusi-explore/edit/{id}', [KontribusiExploreController::class, 'update']); 
...
Route::put('soal-type/edit/{id}', [SoalTypeController::class, 'update']); 
...
Route::put('survey/edit/{id}', [SurveyController::class, 'update']); 
...
Route::put('survey-desain/edit/{id}', [SurveyDesainController::class, 'update']); 
...
Route::put('survey-kriteria/edit/{id}', [SurveyKriteriaController::class, 'update']); 
...
Route::put('survey-soal/edit/{id}', [SurveySoalController::class, 'update']); 
