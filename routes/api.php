...
Route::delete('jawaban-soal/{id}', [JawabanSoalController::class, 'destroy']);  
...
Route::delete('kontribusi-explore/{id}', [KontribusiExploreController::class, 'destroy']);  
...
Route::delete('soal-type/{id}', [SoalTypeController::class, 'destroy']);  
...
Route::delete('survey-desain/{id}', [SurveyDesainController::class, 'destroy']);  
...
Route::delete('survey-kriteria/{id}', [SurveyKriteriaController::class, 'destroy']);  
...
Route::delete('survey-soal/{id}', [SurveySoalController::class, 'destroy']);  